...
Time::Time(const TimeConfig* const timeConfig) : config(timeConfig)
{
    // Nothing to do here
}

BmcTime::BmcTime(const TimeConfig* const timeConfig) : Time(timeConfig)
{
    // Nothing to do here
}

HostTime::HostTime(const TimeConfig* const timeConfig,
                   const std::chrono::microseconds* const hostOffset)
    : Time(timeConfig),
