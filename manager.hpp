...
class Manager
{
    ...
    private:
         ...
         *
         * @param[in] key - The property name to save
         * @param[in] value - The property value to save
         */
        void saveProperty(const std::string& key,
                          const std::string& value);

        /** @brief Set the mode as requested mode and save it to
         *  persistent storage
         *
         * @param[in] mode - The string of time mode
         */
        ...
        /** @brief Set the owner as requested owner and save it to
         *  persistent storage
         *
         * @param[in] owner - The string of time owner
         */
