...
const char *host_time_file = "/var/lib/obmc/saved_host_time";
const char *host_offset_file = "/var/lib/obmc/saved_host_offset";

const char *time_mode_file = "/var/lib/obmc/saved_time_mode";
const char *time_owner_file = "/var/lib/obmc/saved_time_owner";
/*
...
/* Property curr_time_mode reader */
static int property_get_curr_mode(sd_bus *bus, const char *path,
				const char *interface, const char *property,
				sd_bus_message *reply, void *userdata,
				sd_bus_error *error)
{
        return sd_bus_message_append(reply, "s", mode_str(g_curr_time_mode));
}

/* Property curr_time_owner reader */
static int property_get_curr_owner(sd_bus *bus, const char *path,
				const char *interface, const char *property,
				sd_bus_message *reply, void *userdata,
				sd_bus_error *error)
{
        return sd_bus_message_append(reply, "s", owner_str(g_curr_time_owner));
}

/* Property requested_time_mode reader */
static int property_get_req_mode(sd_bus *bus, const char *path,
				const char *interface, const char *property,
				sd_bus_message *reply, void *userdata,
				sd_bus_error *error)
{
        return sd_bus_message_append(reply, "s", mode_str(g_requested_time_mode));
}

/* Property requested_time_owner reader */
static int property_get_req_owner(sd_bus *bus, const char *path,
				const char *interface, const char *property,
				sd_bus_message *reply, void *userdata,
				sd_bus_error *error)
{
        return sd_bus_message_append(reply, "s", owner_str(g_requested_time_owner));
}
...
static const sd_bus_vtable time_services_vtable[] =
{
	...
	SD_BUS_PROPERTY("curr_time_mode", "s", property_get_curr_mode, 0, SD_BUS_VTABLE_PROPERTY_CONST),
	SD_BUS_PROPERTY("curr_time_owner", "s", property_get_curr_owner, 0, SD_BUS_VTABLE_PROPERTY_CONST),
	SD_BUS_PROPERTY("requested_time_mode", "s", property_get_req_mode, 0, SD_BUS_VTABLE_PROPERTY_CONST),
	SD_BUS_PROPERTY("requested_time_owner", "s", property_get_req_owner, 0, SD_BUS_VTABLE_PROPERTY_CONST),
...
int updt_time_owner(const time_owner_t time_owner)
{
	 ...
	 */
	if (g_curr_time_owner == HOST && g_requested_time_owner == HOST) {
